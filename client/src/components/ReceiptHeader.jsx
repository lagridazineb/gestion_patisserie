...
export default function ReceiptHeader({ subtitle, children }) {
  return (
    <div className="text-center pb-3 mb-3 border-b border-dashed border-gray-300">
      <p className="font-fraunces text-lg font-bold tracking-wide text-black uppercase">{SHOP_INFO.name}</p>
      <p className="text-text-black  text-[10px] leading-snug mt-1">{SHOP_INFO.address}</p>
...
export default function ReceiptHeader({ subtitle, children }) {
  return (
    <div className="text-center pb-3 mb-3 border-b border-dashed border-black-300">
      <p className="font-fraunces text-lg font-bold tracking-wide text-black uppercase">{SHOP_INFO.name}</p>
      <p className="text-text-black  text-[10px] leading-snug mt-1">{SHOP_INFO.address}</p>
      <p className="text-black  text-[10px] leading-snug">Tél : {SHOP_INFO.phone}</p>
      {subtitle && <p className="text-black text-[11px] font-semibold mt-2">{subtitle}</p>}
