...
export const translations = {
  fr: {
    ...
    ventes: {
      rapport: 'Rapport', titre: 'Ventes', sousTitre: 'Production par préparateur, retours de caisse et commandes',
      toutesLesDates: 'Toutes les dates', imprimer: 'Imprimer', reinitialiserRetours: 'Réinitialiser les retours',
      modalTitre: 'Réinitialiser les retours de caisse',
      modalDescription: '"Retour du jour précédent" ({value} DH) et le bilan avec retours vont être remis à zéro. Les ventes et la production déjà enregistrées ne sont pas touchées. Entrez votre mot de passe pour confirmer.',
      modalConfirmLabel: 'Réinitialiser',
      statTotalProduction: 'Total production', statCaCommandes: "Chiffre d'affaires commandes",
      statRetourPrecedent: 'Retour du jour précédent', statRetoursFermeture: 'Retours de fermeture',
      perte: 'Perte', retour: 'Retour',
      statBilanAvecRetours: 'Bilan avec retours (production + commandes + retour précédent - retour du jour)',
      retoursCaisse: 'Retours de caisse', jourPrecedent: 'Jour précédent', fermetureDuJour: 'Fermeture du jour',
      pasDeRetourPrecedent: 'Pas encore de retour enregistré pour le jour précédent.',
      pasEncoreCalcule: 'Pas encore calculé : se fait automatiquement au vidage de fin de journée (page Stock).',
      calculeLe: 'Calculé le {date} — réutilisé comme fond de caisse aujourd\'hui.',
      toutesCategoriesConfondues: 'Toutes catégories confondues (pain, viennoiserie, frigo, entremet, salé) : ce qui sera revendu (retour) et ce qui a été jeté (perte).',
      detailProduitParProduit: 'Détail produit par produit', aucunProduitDansCeRetour: 'Aucun produit dans ce retour',
      rienAAfficher: "Rien à afficher — aucune clôture de fin de journée n'a encore été enregistrée pour ce cas.",
      totalProduits: 'Total ({n} produit{s})',
      productionVentesParPreparateur: 'Production & ventes par préparateur', production: 'Production', vente: 'Vente',
      produit: 'Produit', valeurProduite: 'Valeur produite', vendu: 'Vendu', chiffreAffairesNet: "Chiffre d'affaires net",
      detailProductionParProduit: 'Détail production par produit', detailVenteParProduit: 'Détail vente par produit',
      aucuneProductionEnregistree: 'Aucune production enregistrée', aucuneVenteEnregistree: 'Aucune vente enregistrée',
      commandesTitre: 'Commandes — {date}', commandesNote: '(les commandes ne peuvent être consultées que jour par jour)',
      avancesRecues: 'Avances reçues', restesRecuperes: 'Restes récupérés (livraison)',
      choisissezUneCategorie: 'Choisissez une catégorie',
    },
  },
  ar: {
    common: {
    ...
    ventes: {
      rapport: 'تقرير', titre: 'المبيعات', sousTitre: 'الإنتاج حسب المحضّر، مرتجعات الصندوق والطلبات',
      toutesLesDates: 'كل التواريخ', imprimer: 'طباعة', reinitialiserRetours: 'إعادة تعيين المرتجعات',
      modalTitre: 'إعادة تعيين مرتجعات الصندوق',
      modalDescription: 'سيتم إعادة تعيين "مرتجع اليوم السابق" ({value} درهم) والحساب مع المرتجعات إلى الصفر. المبيعات والإنتاج المسجلة مسبقاً لن تتأثر. أدخل كلمة المرور للتأكيد.',
      modalConfirmLabel: 'إعادة التعيين',
      statTotalProduction: 'إجمالي الإنتاج', statCaCommandes: 'رقم معاملات الطلبات',
      statRetourPrecedent: 'مرتجع اليوم السابق', statRetoursFermeture: 'مرتجعات الإغلاق',
      perte: 'خسارة', retour: 'مرتجع',
      statBilanAvecRetours: 'الحساب مع المرتجعات (الإنتاج + الطلبات + مرتجع سابق - مرتجع اليوم)',
      retoursCaisse: 'مرتجعات الصندوق', jourPrecedent: 'اليوم السابق', fermetureDuJour: 'إغلاق اليوم',
      pasDeRetourPrecedent: 'لا يوجد بعد أي مرتجع مسجل لليوم السابق.',
      pasEncoreCalcule: 'لم يُحسب بعد: يتم تلقائياً عند إفراغ نهاية اليوم (صفحة المخزون).',
      calculeLe: 'تم الحساب في {date} — يُستعمل كصندوق افتتاحي اليوم.',
      toutesCategoriesConfondues: 'جميع الفئات مجتمعة (خبز، معجنات، فريجو، كيك دائري، مالح): ما سيُعاد بيعه (مرتجع) وما تم رميه (خسارة).',
      detailProduitParProduit: 'تفصيل حسب المنتج', aucunProduitDansCeRetour: 'لا يوجد أي منتج في هذا المرتجع',
      rienAAfficher: 'لا شيء لعرضه — لم يتم بعد تسجيل أي إغلاق نهاية يوم لهذه الحالة.',
      totalProduits: 'المجموع ({n} منتج)',
      productionVentesParPreparateur: 'الإنتاج والمبيعات حسب المحضّر', production: 'الإنتاج', vente: 'البيع',
      produit: 'المنتج', valeurProduite: 'القيمة المنتجة', vendu: 'المُباع', chiffreAffairesNet: 'صافي رقم المعاملات',
      detailProductionParProduit: 'تفصيل الإنتاج حسب المنتج', detailVenteParProduit: 'تفصيل البيع حسب المنتج',
      aucuneProductionEnregistree: 'لا يوجد إنتاج مسجل', aucuneVenteEnregistree: 'لا توجد مبيعات مسجلة',
      commandesTitre: 'الطلبات — {date}', commandesNote: '(لا يمكن الاطلاع على الطلبات إلا يوماً بيوم)',
      avancesRecues: 'العُربون المستلم', restesRecuperes: 'الباقي المسترجع (التوصيل)',
      choisissezUneCategorie: 'اختر فئة',
    },
  },
}
